...
|------------|------|------------|----------|
| Le Havre Rounded | Sans-serif | 4 | Body text, modern headings |
| Transat | Sans-serif | 4 | Body text, clean headings |
| Chennai | Sans-serif | 4 | Contemporary text, versatile |
| Sketchnote Text | Sans-serif | 3 | Casual, handwritten feel |
| Sketchnote Square | Sans-serif | 1 | Display, decorative |
| Omnes Narrow | Sans-serif | 4 | Condensed layouts, headers |
...
### Primary Body Text Fonts
- **Le Havre Rounded** - Modern, friendly rounded sans-serif
- **Transat** - Clean geometric sans-serif
- **Chennai** - Contemporary versatile sans-serif
- **Omnes Pro** - Professional sans-serif (Medium weight)

### Display & Headline Fonts
- **Sketchnote Text** - Casual handwritten style
...
```html
<!-- Le Havre Rounded -->
<h1 class="tk-le-havre-rounded">Modern Headline</h1>

<!-- Transat -->
<p class="tk-transat">Clean body text</p>

<!-- Chennai -->
<div class="tk-chennai">Contemporary content</div>

<!-- Sketchnote Text -->
<h2 class="tk-sketchnote-text">Casual Header</h2>
...
<h1 class="tk-elliotts-jigsaw-dropshadow">Eye-Catching</h1>
```
...
### Website Body Text
1. **Transat Regular** (400) - Clean, modern
2. **Chennai Regular** (400) - Contemporary
3. **Omnes Pro Medium** (500) - Professional

### Headlines & Titles
1. **Le Havre Rounded Bold** (700) - Friendly, approachable
...
2. **Sketchnote Square** - Playful display
...
### Professional & Clean
- **Headings**: Le Havre Rounded Bold
- **Body**: Transat Regular
- **Accents**: Omnes Pro Medium

### Modern & Contemporary
- **Headings**: Chennai Bold
- **Body**: Chennai Regular
- **Display**: Omnes Narrow Black

### Casual & Friendly
- **Headings**: Sketchnote Text Bold
...
The fonts use `font-display: auto` which allows the browser to determine the best loading strategy based on network conditions.

---

## Browser Compatibility

All fonts work across:
- ✅ Chrome/Edge (all versions with WOFF2 support)
- ✅ Firefox (all versions with WOFF2 support)
- ✅ Safari/iOS Safari (all modern versions)
- ✅ Opera (all modern versions)
- ✅ Legacy browsers (via WOFF and OpenType fallbacks)
